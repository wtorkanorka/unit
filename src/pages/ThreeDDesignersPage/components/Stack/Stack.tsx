    ...
    <div className={styles["our-stack"]}>
      ...
      <div className={styles["info"]}>
        ...
        <p className={styles["text"]}>
          <span>М</span>ы используем современные програмные расширения для
          создания крупномаштабных игровых и дизайнерских проектов с помощью
          технологии 3D моделирования. <span>М</span>ы всегда рады помочь тебе
          справиться со всеми трудностями обучения и помни утка следит за тобой.
        </p>
      </div>
    </div>
  );
