    ...
    <div className={styles["stack-container"]}>
      ...
      <div className={styles["info"]}>
        ...
        <p className={styles["text"]}>
          ...
          програмных, рекламных и других систем, что позволят пользователю лучше
          воспринять продукт, а также способствует повышению узнаваемости
          бренда. <span>В</span>ступай к нам мы поможеим тебе научится этому.
        </p>
      </div>
    </div>
  );
